...
\subcaptionbox{Price rises and falls.}
  [0.4\textwidth]{\includegraphics{diag_p1_p2_inc.pdf}}
\hfill
\subcaptionbox{Price falls and rises.}
  [0.4\textwidth]{\includegraphics{diag_p1_p2_dec.pdf}}
...
\hfill  % move pictures apart at equal distance
\subcaptionbox{Price rises and falls.}
  [0.4\textwidth]{\includegraphics{diag_p1_p2_p3_dec.pdf}}
\hfill
\subcaptionbox{Price falls and rises.}
  [0.4\textwidth]{\includegraphics{diag_p1_p2_p3_inc.pdf}}
\hfill
...
\vhEntry{1.1}{23 Feb 2023}{VB}{Minor text corrections; added total loss equation.}
\end{versionhistory}
